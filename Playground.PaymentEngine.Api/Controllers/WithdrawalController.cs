...
using CreateWithdrawalRequest = Playground.PaymentEngine.Application.UseCases.Withdrawals.CreateWithdrawal.CreateWithdrawalRequest;
using ViewModel = Playground.PaymentEngine.Api.Models.Withdrawals;
using Withdrawal = Playground.PaymentEngine.Api.Models.Withdrawals.Withdrawal;
