...
using Application.UseCases.Allocations.AutoAllocate;
using Application.UseCases.Allocations.CreateAllocation;
using Application.UseCases.Allocations.DeleteAllocation;
using Application.UseCases.Allocations.GetAllocation;
using Application.UseCases.Allocations.GetAllocations;
