...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.Playground.PaymentEngine.Web.Client.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/SoftwareAteliers.Playground.PaymentEngine.Web.Client/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.Playground.PaymentEngine.Web.Client`
...
Browse to [http://localhost:8000](http://localhost:8000) for ASP.&#8203;NET Core + Vue app or browse to [http://localhost:8080](http://localhost:8080) for Vue app only.
