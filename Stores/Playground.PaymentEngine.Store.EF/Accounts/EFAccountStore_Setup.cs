...
public partial class EFAccountStore {
    ...
    private static object[] DefaultAccounts => new object[] {
        new Account {
            Id = 267, AccountTypeId = 88, CustomerId = 2, Exposure = 30.0M, IsPreferredAccount = false, TenantId = 1
        },
        new Account {
            Id = 300, AccountTypeId = 90, CustomerId = 44, Exposure = 132.0M, IsPreferredAccount = true, TenantId = 1
        },
        new Account {
            Id = 567, AccountTypeId = 98, CustomerId = 44, Exposure = 3.0M, IsPreferredAccount = false, TenantId = 1
        },
        new Account {
            Id = 747, AccountTypeId = 88, CustomerId = 74, Exposure = 0M, IsPreferredAccount = false, TenantId = 1
        }
    };
